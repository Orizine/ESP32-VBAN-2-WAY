...
/** Return VBanINHeader pointer from buffer */
#define PACKET_HEADER_PTR(_buffer) ((struct VBanINHeader*)_buffer)
...
#define PACKET_PAYLOAD_SIZE(_size) (_size - sizeof(struct VBanINHeader))
